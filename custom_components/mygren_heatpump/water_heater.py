...
class MygrenWaterHeater(CoordinatorEntity, WaterHeaterEntity):
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        await self.hass.async_add_executor_job(
            self._api.set_tuv_temperature, temperature
        )
    ...
    async def async_set_operation_mode(self, operation_mode: str) -> None:
        ...
        await self.hass.async_add_executor_job(
            self._api.set_tuv_enabled, enabled
        )
        await self.coordinator.async_request_refresh()
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            "tuv_min": self.coordinator.data.get("tuvmin"),
            "tuv_max": self.coordinator.data.get("tuvmax"),
